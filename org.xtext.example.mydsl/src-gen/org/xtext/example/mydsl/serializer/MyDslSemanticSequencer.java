...
public class MyDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=EString state+=Initial state+=Final (state+=State state+=State* (transition+=Transition transition+=Transition*)*)+)
	 */
	 ...
	 *
	 * Constraint:
	 *     (name=EString state+=[State|EString] state+=[State|EString] trigger=EString)
	 */
