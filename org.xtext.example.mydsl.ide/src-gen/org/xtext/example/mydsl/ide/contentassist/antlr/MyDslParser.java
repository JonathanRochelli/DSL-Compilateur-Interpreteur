...
public class MyDslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, MyDslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getTransitionAccess().getStateAssignment_2_0(), "rule__Transition__StateAssignment_2_0");
			builder.put(grammarAccess.getTransitionAccess().getStateAssignment_2_1_1(), "rule__Transition__StateAssignment_2_1_1");
			builder.put(grammarAccess.getTransitionAccess().getTriggerAssignment_2_3(), "rule__Transition__TriggerAssignment_2_3");
